...
<div class="max-w-xl">
    <div class="mb-6">
        ...
        <h1 class="text-xl font-semibold text-gray-800 mt-2">Tambah Balita Baru</h1>
    </div>
    ...
    <form method="POST" action="{{ route('kader.balita.store') }}">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-5 space-y-4 shadow-sm">
            ...
            <div>
                ...
                <textarea name="alamat" rows="2" placeholder="Alamat lengkap"
                          class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-2.5
                                 text-sm text-gray-800 placeholder-gray-400 focus:outline-none
                                 focus:border-teal-500 focus:bg-white transition-colors resize-none">{{ old('alamat') }}</textarea>
            </div>
        </div>
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('kader.balita.index') }}"
            class="px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm rounded-lg transition-colors border border-gray-200">
                Batal
            </a>
        </div>
    </form>
